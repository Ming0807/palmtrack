...
PalmTrack ทำให้งานเก็บข้อมูลวิจัยและการบริหารสวนปาล์มเป็น workflow เดียวที่ตรวจสอบย้อนกลับได้ ตั้งแต่ประชากรและกลุ่มตัวอย่างผ่าน Consent จนถึงข้อมูลสวน กระแสเงินสด และรายงาน ความสำเร็จของ V1 คือทีมวิจัยนักศึกษาสามารถทดลองกับข้อมูลสังเคราะห์ครบ flow บนมือถือ โดยสิทธิ์ การถอนความยินยอม สูตรคำนวณ และหลักฐาน Audit ผ่านเกณฑ์ที่กำหนด

## Positioning

PalmTrack ไม่ใช่เพียงแบบสอบถามออนไลน์หรือสมุดบัญชีสวน แต่เชื่อมหลักฐานการสุ่ม Assignment และ Consent เข้ากับข้อมูลสวนและรายงานชุดเดียว โดยรักษาขอบเขตสิทธิ์และ reproducibility ตั้งแต่ต้น

## Operating Context

ระบบใช้ในงานภาคสนามอำเภอศรีสาคร จังหวัดนราธิวาส ผู้ใช้หลักทำงานบนโทรศัพท์ จอเล็ก และอินเทอร์เน็ตไม่สม่ำเสมอ งานสำคัญคือดู Assignment แสดง Privacy Notice บันทึก Consent เก็บแบบร่าง ตรวจ/ส่งข้อมูล และกลับมาบันทึกรายจ่าย ผลผลิต หรือการขายภายหลัง ผู้จัดการใช้หน้าจอเดสก์ท็อปหรือแท็บเล็ตเพื่อติดตาม funnel ตรวจแบบสอบถาม และ export หลักฐาน
...
1. Consent และสิทธิ์มาก่อนความสะดวกของผู้ดูแลระบบ
